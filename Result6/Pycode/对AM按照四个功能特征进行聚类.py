...
am_clinic = clinic_data_filter[clinic_data_filter["group"]=="AM"]
...
# data_scaled.to_csv("../../data/result6/result/AM按四个功能特征聚类后的按行归一化结果数据.csv")
data_scaled = pd.read_csv("../../data/result6/result/AM按四个功能特征聚类后的按行归一化结果数据.csv", index_col=0)
...
# cluster_labels.to_csv("../../data/result6/result/AM四个功能特征聚类结果.csv")
...
# g.savefig("../../figure/result6/基于黑色素细胞功能的结果图/AM按四个功能特征评分聚类结果图.pdf")
